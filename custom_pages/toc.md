...
### 2. Terminal Equipment and Recycling Requirements

#### 2.1 Free Terminal Program

Prahsys may, at its sole discretion, provide payment terminals to Channel Partner or Merchant at no cost under the Free Terminal Program, subject to the ownership verification and recycling requirements set forth in this Section 2.

#### 2.2 Ownership Requirement

Channel Partner or Merchant represents and warrants that it has full legal title and ownership of any existing payment terminals surrendered to Prahsys under this Section 2. Channel Partner or Merchant shall not surrender any terminals that are leased, financed, or otherwise subject to any third-party ownership interest, lien, or encumbrance. Channel Partner or Merchant agrees to indemnify and hold harmless Prahsys from any claims, damages, or liabilities arising from Channel Partner or Merchant's surrender of terminals that Channel Partner or Merchant does not fully own.

#### 2.3 Recycling Requirement

As a condition of receiving free terminals under the Free Terminal Program, Channel Partner or Merchant must surrender any existing payment terminals from previous providers to Prahsys for proper recycling and disposal in accordance with applicable environmental regulations. Channel Partner or Merchant shall ensure that all surrendered terminals are delivered to Prahsys in their complete form, including all components, cables, and accessories originally provided with such terminals.

#### 2.4 Non-Compliance

If Channel Partner or Merchant fails to surrender existing terminals for recycling as required under this Section 2.3, or if Channel Partner or Merchant surrenders terminals that Channel Partner or Merchant does not fully own in violation of Section 2.2, Prahsys reserves the right to: (i) charge Channel Partner or Merchant the full retail cost of any terminals provided, or (ii) terminate Channel Partner or Merchant's participation in the Free Terminal Program and require return of all terminals provided under such program.

#### 2.5 Data Security

Prior to surrendering any terminal to Prahsys, Channel Partner or Merchant must properly clear all sensitive payment card data and confidential information from surrendered terminals in accordance with PCI DSS requirements and applicable data security standards. Channel Partner or Merchant remains solely responsible for any data security breaches or non-compliance resulting from improper data sanitization of surrendered terminals.

#### 2.6 Post-Termination

Upon termination of this Agreement for any reason, Channel Partner or Merchant must either: (i) return all terminals provided under the Free Terminal Program to Prahsys in good working condition, normal wear and tear excepted, or (ii) pay Prahsys the full retail cost of any unreturned terminals. This obligation shall survive termination of this Agreement.

### 3. Unsecured Obligations of Prahsys; Subordination
...
#### 4.4 Loss of Confidential Information
...
#### 4.6 Prior Non-Disclosure Agreement
...
#### 5.2 Trademark, Trade Name and Other Marks
...
#### 6.1 Channel Partner represents continuously during the Term of this Agreement:
...
#### 6.3 Prahsys represents continuously during the Term of this Agreement:
...
### 10. Liability of Administrative Agent
...
Bldg. 8, Level 2, Ste. 8210
The Woodlands, TX 77380
[support@prahsys.com](mailto:support@prahsys.com)
...
### 24. Practitioner Agreements on Data Use
...
### 25. Platform and Service Fees

While platform access is currently provided at no additional charge beyond the standard payment processing fees, Prahsys reserves the absolute right and discretion to implement, modify, or adjust platform fees, service fees, subscription fees, or other charges at any time for any reason, including but not limited to platform improvements, regulatory compliance, operational costs, or business requirements.

Prahsys will provide Merchants with thirty (30) days advance notice of any fee implementation or modification through any of the following methods, at Prahsys's sole discretion: Merchant dashboard notifications, monthly statements, email to the address on file, or posting on the Merchant portal. Notice shall be deemed effective upon transmission or posting, regardless of actual receipt.

Any platform fees implemented may vary by Merchant based on transaction volume, account type, services utilized, risk profile, or other factors as determined by Prahsys in its sole discretion. Fees may be charged as flat monthly fees, per-transaction fees, percentage-based fees, or any combination thereof.

Continued use of platform services for any period after the effective date specified in the notice constitutes full acceptance of all fee changes. Merchant acknowledges that processing even a single transaction after the effective date demonstrates acceptance of the revised fee structure.

If Merchant objects to any fee implementation or modification, Merchant's sole remedy is to terminate this agreement in accordance with the termination provisions herein, subject to all applicable early termination fees, outstanding obligations, and post-termination survival clauses.

All fees are non-refundable once charged and shall be in addition to all other fees, charges, and costs under this Agreement.

### 26. Patient Data Sharing and Diagnostic Image Access

This Section 26 applies whenever Channel Partner or Merchant, or any of its practitioners (each, as applicable, the “Practice”), uses the PrognosiX platform to share a scan, image, or other diagnostic imaging (collectively, “Patient Imaging”) with a patient or any other individual (each, a “Recipient”).

#### 26.1 Practice Control and Responsibility

The Practice is solely responsible for its decision to share any Patient Imaging, including selecting the Patient Imaging to be shared, identifying each Recipient, and confirming the accuracy of the contact information used to deliver it. Prahsys does not select Recipients, review the clinical content of Patient Imaging, or independently verify a Recipient’s identity or entitlement to receive it, and Prahsys acts only on the Practice’s instruction.

#### 26.2 Covered Entity; Business Associate

As between the Parties, the Practice is the “covered entity” and the owner and custodian of the medical record containing the Patient Imaging, and Prahsys acts solely as the Practice’s “business associate” and conduit for the limited purpose of delivering Patient Imaging to the Recipient the Practice designates, in each case as those terms are used under the Health Insurance Portability and Accountability Act of 1996 and its implementing regulations (“HIPAA”). Each Party’s handling of protected health information is governed by the business associate agreement in effect between the Parties, which controls in the event of any conflict with this Section 26.

#### 26.3 Authorization and Verification

The Practice represents and warrants, on a continuing basis, that for each instance of sharing it has (i) the right and all authorizations, consents, and legal bases required to disclose the Patient Imaging to the Recipient, (ii) verified the Recipient’s identity and contact information to the extent required by applicable law and professional standards, and (iii) provided the Recipient with any notices required by law. The Practice is responsible for promptly disabling or requesting revocation of access when sharing is no longer authorized or appropriate.

#### 26.4 Investigational Use Limitation

The Practice acknowledges that PrognosiX artificial intelligence outputs, including any segmentation or pulp-tissue overlay, are generated by investigational software that has not been cleared or approved by the U.S. Food and Drug Administration, is not for diagnostic use or patient care, and is provided for evaluation only. The Practice shall not represent any PrognosiX output to a Recipient as a diagnosis, as a substitute for professional clinical judgment, or as cleared, approved, or validated. The Practice shall ensure that any Patient Imaging shared with a Recipient that includes such output is accompanied by the informational-use, investigational-status, and consult-your-treating-provider notices made available through the platform, and shall not remove, alter, obscure, or suppress those notices. The Practice remains solely responsible for the interpretation of, and all clinical decisions relating to, any Patient Imaging.

#### 26.5 Delivery and Onward Disclosure

The Practice acknowledges that Patient Imaging is delivered by electronic means, including email and access-controlled links, and that such delivery carries inherent risks of interception, mis-delivery, and onward re-disclosure that Prahsys does not control. Prahsys is not responsible for a Recipient’s or any third party’s forwarding, further disclosure, or misuse of a shared link or of Patient Imaging after it has been delivered in accordance with the Practice’s instructions. Shared links may expire after a period of time and may be revoked by the Practice or by Prahsys.

#### 26.6 Prohibited Use and Security

The Practice shall use the sharing feature only for legitimate purposes related to the care of its own patients and in compliance with all applicable laws. The Practice shall not, and shall not permit any Recipient or third party to, use the feature to distribute imaging the Practice is not authorized to share, to send unsolicited or bulk communications, to attempt to access imaging or accounts belonging to others, or to probe, scan, reverse engineer, or circumvent any security or access control of the platform. The Practice shall safeguard its account credentials and promptly notify Prahsys at [support@prahsys.com](mailto:support@prahsys.com) of any suspected unauthorized access or misuse.

#### 26.7 Indemnification and Disclaimer

In addition to and without limiting the indemnification obligations elsewhere in this Agreement, the Practice shall indemnify, defend, and hold harmless Prahsys and its affiliates, and their respective directors and officers, from and against any and all claims, liabilities, losses, damages, penalties, costs, and expenses arising out of or relating to (i) the Practice’s decision to share, or failure to properly restrict or revoke, any Patient Imaging, (ii) the disclosure of Patient Imaging to an unintended, unauthorized, or incorrectly identified Recipient as a result of information or instructions provided by the Practice, (iii) the forwarding, further disclosure, or misuse of a shared link or Patient Imaging by a Recipient or any third party after delivery in accordance with the Practice’s instructions, where not caused by Prahsys, (iv) the Practice’s breach of any representation, warranty, or obligation in this Section 26, or (v) the Practice’s or any Recipient’s reliance on any PrognosiX output for a diagnostic or clinical purpose. Prahsys makes no representation or warranty regarding the clinical accuracy, completeness, or fitness for any particular purpose of any Patient Imaging or PrognosiX output, and disclaims all such warranties to the maximum extent permitted by law. The limitations of liability set forth in Section 12 apply to this Section 26.

#### 26.8 Suspension

Prahsys may suspend, disable, or revoke access to shared Patient Imaging, or to the sharing feature, at any time if Prahsys reasonably believes that continued availability presents a security, privacy, legal, or regulatory risk, or that the feature is being used in violation of this Section 26, and shall use commercially reasonable efforts to notify the Practice when it does so.

#### 26.9 Survival

The obligations in this Section 26 that by their nature should survive termination, including Section 26.7 and the data-handling obligations referenced herein, shall survive termination of this Agreement.