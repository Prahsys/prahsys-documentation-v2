...
**Method 1: Send to customers on the order.** Use the boolean flags to send to all emails or phone numbers of customers attached to the order (_if there are no customers attached to the order, then nothing will be sent_):
