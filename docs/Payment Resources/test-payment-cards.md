...
## What Are Test Cards?                                                                                                                                               
  ...
  Use card number **4111111111111111** (Visa) for all testing below.

  ### Transaction Responses

  | Card Number      | Amount  | CVV | Outcome                      |
  | ---------------- | ------- | --- | ---------------------------- |
  | 4111111111111111 | 1.00    | 001 | Approved                     |
  | 4111111111111111 | -1      | 001 | Invalid Request              |
  | 4111111111111111 | 7001.00 | 001 | Declined — Invalid Card      |
  | 4111111111111111 | 7007.00 | 001 | Declined — Invalid Amount    |
  | 4111111111111111 | 7012.00 | 001 | Declined — Invalid Expiry    |
  | 4111111111111111 | 7120.00 | 001 | Declined — Invalid Currency  |
  ...
  | Card Number      | Amount | CVV | Outcome           |
  | ---------------- | ------ | --- | ----------------- |
  | 4111111111111111 | 0.00   | 001 | CVV Match         |
  | 4111111111111111 | 0.00   | 002 | CVV No Match      |
  | 4111111111111111 | 0.00   | 003 | CVV Not Processed |
  | 4111111111111111 | 0.00   | 004 | CVV Suspicious    |
  | 4111111111111111 | 0.00   | 005 | CVV Unavailable   |

  Or trigger CVV responses by amount (using any CVV like 123):

  | Card Number      | Amount  | CVV | Outcome           |
  | ---------------- | ------- | --- | ----------------- |
  | 4111111111111111 | 2001.00 | 123 | CVV Match         |
  | 4111111111111111 | 2002.00 | 123 | CVV No Match      |
  | 4111111111111111 | 2003.00 | 123 | CVV Not Processed |
  | 4111111111111111 | 2004.00 | 123 | CVV Suspicious    |
  | 4111111111111111 | 2005.00 | 123 | CVV Unavailable   |
  ...
  | Card Number      | Amount  | CVV | Outcome                             |
  | ---------------- | ------- | --- | ----------------------------------- |
  | 4111111111111111 | 1013.00 | 123 | AVS Full Match (address + zip)      |
  | 4111111111111111 | 1001.00 | 123 | AVS Address Match Only              |
  | 4111111111111111 | 1014.00 | 123 | AVS Zip Match Only                  |
  | 4111111111111111 | 1009.00 | 123 | AVS No Match                        |
  | 4111111111111111 | 1012.00 | 123 | AVS Unavailable                     |
  | 4111111111111111 | 1011.00 | 123 | AVS System Unavailable (retry)      |
  | 4111111111111111 | 1006.00 | 123 | AVS Not Supported (non-US issuer)   |

  Or trigger AVS responses by CVV value (using amount $0.00):

  | Card Number      | Amount | CVV | Outcome                             |
  | ---------------- | ------ | --- | ----------------------------------- |
  | 4111111111111111 | 0.00   | 033 | AVS Full Match (address + zip)      |
  | 4111111111111111 | 0.00   | 021 | AVS Address Match Only              |
  | 4111111111111111 | 0.00   | 034 | AVS Zip Match Only                  |
  | 4111111111111111 | 0.00   | 029 | AVS No Match                        |
  | 4111111111111111 | 0.00   | 032 | AVS Unavailable                     |
  | 4111111111111111 | 0.00   | 031 | AVS System Unavailable (retry)      |
  | 4111111111111111 | 0.00   | 026 | AVS Not Supported (non-US issuer)   |
  ...
  | N    | No match: neither street address nor postal code      |
  ...
  Use any of the cards below for sandbox testing. For most testing, **4111111111111111** (Visa) is recommended.
  ...
  | 4622943127013705 | 838 |
  | 4622943127013713 | 043 |
  | 4622943127013721 | 258 |
  | 4622943127013739 | 942 |
  | 4622943127013747 | 370 |

  ### Mastercard

  | Card Number      | CVV |
  | ---------------- | --- |
  | 2222420000001113 | Any |
  | 2222630000001125 | Any |
  | 5555555555554444 | Any |
